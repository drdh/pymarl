...
import torch as th
from torch.distributions import MultivariateNormal,Gumbel
from torch.distributions import kl_divergence
import torch.distributions as D


class LatentCatRNNAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(LatentCatRNNAgent, self).__init__()
        self.args = args
        ...
        self.embed_fc = nn.Linear(args.n_agents, args.latent_dim)
        ...
        self.latent = th.rand(self.n_agents, self.latent_dim) #categorical, num_role=latent_dim
