...
class LatentInputRNNAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(LatentInputRNNAgent, self).__init__()
        self.args = args
    ...
    def init_latent(self,bs):
        ...
        self.latent=th.tensor([
            ...
            [0, 1],
            [0, 1]
        ]).unsqueeze(0).expand(bs,self.n_agents,self.latent_dim).reshape(-1,self.latent_dim)
        loss=0
